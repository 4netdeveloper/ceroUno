...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Mobile Presence");
        setSupportActionBar(toolbar);

        //firebase
        locations = FirebaseDatabase.getInstance().getReference("Locations");
        onlineRef = FirebaseDatabase.getInstance().getReference().child(".info/connected");
        counterRef = FirebaseDatabase.getInstance().getReference("lastOnline"); //create new chil name lastOnline
        ...
        //after setup, we just load all user from counterRef and display on RecyclerView
        //this is online list
        updateList();
    }
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                Toast.makeText(this,"Este dispositivo no está soportado", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
